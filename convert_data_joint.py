...
def main(args):
    ...
    input_dir = "/Users/shaswatgarg/Documents/Job/ArenaX/Development/heirarchical_RL/dataset/FrankaIkGolfCourseEnv-v0/val"  # <-- change this
    ...
    for filename in npz_files:
        ...
        for i in range(len(ep["actions"])):
            joint_dataset["actions"].append(env.unwrapped.robot_model.data.ctrl)
            action = ep["actions"][i]
