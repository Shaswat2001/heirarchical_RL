...
high_level_memory = RandomMemory(memory_size=200000, num_envs=env.num_envs, device=device, replacement=False)
high_level_secondary_memory = RandomMemory(memory_size=10, num_envs=env.num_envs, device=device, replacement=False)
low_level_memory = RandomMemory(memory_size=200000, num_envs=env.num_envs, device=device, replacement=False)
...
cfg["high_policy_sample_step"] = 10
